...
export default class Footer extends React.Component {
    render() {
        return(
            <div className="align-bottom bg-light text-black py-2 text-center">
            	<hr/>
            	<footer>
	        		<div className="container">
	               		<div className="contact-icons">
			               	...
			               	<p id="icons">
			                    ...
			                    <a href="https://twitter.com/udon12thave?lang=en" className="text-light mr-3" aria-label="twitter page">
			                    ...
			                    <a href="mailto:info@freshudon.com" className="text-light mr-3" aria-label="send email">
			                    ...
			                    <a href="https://www.instagram.com/explore/locations/791557990/" className="text-light mr-3" aria-label="ig page">
