    ...
    render() {
        return(
            <div className="container">
                <div className="udon-fresh text-center">
                ...
                <div className="grand-opening text-center">
                ...
                <div className="udon-red menu-header text-center" style={{lineHeight: 40 + "px"}}><strong style={{color: "black"}}>U<span className="udon-red">:D</span>on</strong> Business Hours:</div>
