        ...
        return (
            <div className="container align-items-center">
                ...
                <div className="text-center">
                    <h2 >It's as easy as <span className="udon-red">1, 2, 3!</span></h2>
                </div>
                <div className="d-flex flex-nowrap text-center my-2">
                    <div className="mx-4">
                        <p>Step 1: Choose your favorite <span className="udon-red">NOODLE!</span></p>
                        <img src="https://udonseattle.files.wordpress.com/2011/12/menu-kitsune.png?w=170" alt="" />
                        <p><i>Kitsune Udon</i></p>
                    </div>
                    <div className="mx-4">
                        <p>Step 2: Add your favorite <span className="udon-red">TOPPINGS & SIDES!</span></p>
